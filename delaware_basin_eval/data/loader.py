...
WELL_CANONICAL = {
    ...
    "tvd":            ["true vertical depth", "tvd", "tvd (ft)", "tvd_ft"],
    "spud_date":      ["spud date", "spud_date", "spudded", "spuddate"],
